...
func transformCLI() *cobra.Command {
	...
	transformCmd.Flags().IntVarP(&maxRecords, "max-records", "l", 0, "maximum number of company records to save (0 = unlimited, useful for testing with limited disk space)")
	return transformCmd
}
